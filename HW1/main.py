...
def main():
    ...
    cls_optimizer = optim.SGD([{'params': block_main.module.cls_net.parameters()},
                               ...
                               # {'params': block_main.module.fc_prior.parameters(), 'lr': base_lr*cls_lr_ratio},
                               # {'params': block_main.module.fc_secondary.parameters(), 'lr': base_lr*cls_lr_ratio},
                               # {'params': block_main.module.position_select.parameters(), 'lr': base_lr*cls_lr_ratio},
                               # {'params': block_main.module.prior_att_pool.parameters(), 'lr': base_lr*cls_lr_ratio},
                               # {'params': block_main.module.secondary_att_pool.parameters(), 'lr': base_lr*cls_lr_ratio},
